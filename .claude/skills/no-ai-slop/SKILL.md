<!-- Source: petergyang/no-ai-slop, MIT License, imported 2026-09-09; scanned with skillspector 2.11.1 before install: 3 MEDIUM findings, all false positives (README npx line, self-referential path match) -->
---
name: no-ai-slop
