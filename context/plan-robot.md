...
blockers: `capture.py` and `checkup.py` still import `jetbot`, which cannot load on this host (package 3). The dependencies they really need are installed; the rewrite of the two import sites is not done
---
