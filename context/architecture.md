...
- **JetBot** — sensor platform. Driving, capture the camera image, stream image for the control UI, store shots. Later optionally a small pre-trained model during the drive. Never: pose estimation, never 3DGS training.
