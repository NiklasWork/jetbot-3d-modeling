...
focus: pipeline-3d done through package 5; the robot side is written and unexecuted — `repos/robot/checkup.py` is the first thing to run once the device is up, and it decides whether the camera reaches 1280×960 at all. Engine lifted to main at rc.3+2 (`d4b14ee`)
